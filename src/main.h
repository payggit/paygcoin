...
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 250000; //250KB
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 17000; //17KB
...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 PGC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 PGC mininput
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250; //1day = 720 blocks (blocktime 2 minutes)
    }
