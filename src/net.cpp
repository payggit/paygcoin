...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Paygcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	{"15.164.99.50", "15.164.99.50"},
	{"15.164.170.4", "15.164.170.4"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Paygcoin is probably already running."), addrBind.ToString().c_str());
        else
